# A modified version of LLMGraphTransformer from https://github.com/langchain-ai/langchain-experimental
...
def get_default_prompt(user_examples:dict={},
    ...
    return ChatPromptTemplate.from_messages(
        [
            ("system", system_prompt+example_string),
            (
                "human",
...
class LLMGraphTransformer:
    ...
    Args:
        ...
        user_examples: dict containing examples to be used in generating the graph
    ...
    def __init__(
        ...
        if not self._function_call or user_examples is not None:
            ...
            prompt = prompt or get_default_prompt(user_examples,additional_instructions)
